...
public class Magpie3
{
	...
	public String getResponse(String statement)
	{
		...
		else if (findKeyword(statement, "Chen") >= 0){
					response = "I have to give him 100 Kunka kash I guess.";
		}
		else if (findKeyword(statement, "Asha") >= 0){
					response = "He touches you too?";
		}
		else if (findKeyword(statement, "James") >= 0){
					response = " I know him he's the best.";
		}
		else if (findKeyword(statement, "Noah") >= 0){
					response = "Oh no!";
		}
		else
		{
